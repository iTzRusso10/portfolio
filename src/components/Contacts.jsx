...
const Contacts = () => {
  return (
    <>
      {/* Versione Mobile */}
      <div className="flex h-full w-full flex-col justify-center md:hidden">
        ...
        <div className="flex flex-col justify-center gap-3 p-10">
          ...
          <div className=" mr-auto flex cursor-pointer items-center gap-2 rounded-md bg-[#B205BB] p-3 hover:bg-[#81028a] active:bg-[#67026e]">
      ...
      <div className="h-full w-full max-[768px]:hidden">
        <div className="flex justify-center">
          <h1 className="text-4xl font-black text-white">
            Contact<span className="text-[#B205BB]">s</span>
          </h1>
        ...
        <div className="flex">
          <div className="flex-start  flex w-[50%]">
            <WorldCanvas />
          </div>
          <div className="flex flex-col justify-center gap-3 p-10">
            <div className="flex flex-col justify-center gap-2">
